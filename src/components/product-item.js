...
class ProductItem extends Component{
    ...
    render(){
        ...
        <Text style={style.content}>{format.number(product.price)} d/kg</Text>
        <Rating imageSize={10} startingValue={product.avg_ratings}
        readonly/>
                        </View>
                    </View>
                    <View style={style.rightItem}>
                        <Button backgroundColor='#e01a2e' borderRadius={10}
